...
/** simple class for specifying tiles in a texture by pixels. returns texture coordinates for pixel coordinates. usefull for glyphs
 * etc.
 * 
...
public class TextureTile {
	...
	/** calculates the texture coordinates and width of the specified tile in the texture coorindate space. uses the dimensions of
	 * tex for the basis of calculation
	 * 
