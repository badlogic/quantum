...
public class Slider extends Widget {
	...
	public void setMinimumValue (float value) {
		if (value > max_value) throw new RuntimeException("maximum value > minimum value");
		min_value = value;
	}
	...
	public void setMaximumValue (float value) {
		if (value < min_value) throw new RuntimeException("maximum value > minimum value");
		max_value = value;
	}
	...
	public void render (GLCanvas canvas) {
		...
		float scale = 0;
		if (max_value != min_value) scale = (value - min_value) / (max_value - min_value);
