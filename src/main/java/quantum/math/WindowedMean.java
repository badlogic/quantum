 ...
 * value in case enough data has been sampled. After enough data has been sampled the oldest sample will be replace by the newest
...
public strictfp class WindowedMean {
	...
	/** returns the variance of the data. this will only return a meaningfull value when enough data has been added ( >= window_size
