...
public class GameReplay extends JFrame implements GLEventListener {
	...
	public void display (GLAutoDrawable canvas) {
		...
		try {
			if (!paused) loop.update((GLCanvas)canvas);
