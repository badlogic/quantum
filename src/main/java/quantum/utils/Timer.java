...
/** a simple timer class with start and stop functionality as well as averaging n time measurements.
 * 
...
public class Timer {
	...
	/** constructor, avg_num defines how many measurements should be saved for averaging the timing, must be >= 1
	 * 
	 * @param avg_num */
	...
	/** starts a new measurement or resumes a previously paused measurement */
	public void start () {
		start_time = System.nanoTime();
	}

	/** pauses the current measurement, use start to resume it. */
	public void pause () {
	...
	/** returns wheter the timer is running or stopped/paused
	 * @return */
	public boolean isRunning () {
		return start_time != -1;
	}

	/** returns the elapsed time of the current measurement in seconds
	 * @return */
	...
	/** returns the average over the last measured times
	 * @return */
